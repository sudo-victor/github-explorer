    ...
    <Background>
      <Container>
        <RepoInfo>
          ...
          <TextGroup>
            <TitleAnimation>{String(repository.full_name)}</TitleAnimation>
        ...
        <RepoStats>
          <Stars>
            <StarsCounter>{String(repository.stargazers_count)}</StarsCounter>
            <StarsText>Stars</StarsText>
          </Stars>

          <Forks>
            <ForksCounter>{String(repository.forks_count)}</ForksCounter>
            <ForksText>Forks</ForksText>
          </Forks>

          <OpenIssues>
            <OpenIssuesCounter>
              {String(repository.issues.length)}
            </OpenIssuesCounter>
